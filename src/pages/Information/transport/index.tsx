    ...
    <Fragment>
      ...
      <SimpleGrid columns={2} columnGap={25} ml={10} mr={10} mt={5}>
        <GridItem alignItems={"left"}>
          ...
          <DefaultLabel text={"4. The home page appears, so enther the password 'Brisa' and check the box below it"} valueLabel={""} mt={0}/>
        ...
        <GridItem>
          ...
          <Text textAlign={['left']} fontSize="22" fontWeight={400} color={"#121212"} mt={10}>
            <b>Obs.:</b> Please, if possible, leave the AC unit inside the rooms on at all times around 70-72 degrees because of the high humidity in FLorida
          </Text>
